...
#define DEFINE_TAGS_helper(r, data, i, elem) BOOST_PP_COMMA_IF(i) BLOCK_TAG_ENUM(elem)

#define DEFINE_TAGS BOOST_PP_SEQ_FOR_EACH_I(DEFINE_TAGS_helper,_,BLOCK_TAGS_DATA)
...
#define DEFINE_PARSER BOOST_PP_SEQ_FOR_EACH_I(DEFINE_PARSER_helper,_,BLOCK_TAGS_DATA)
...
#define DEFINE_QC_CONSTRUCTS BOOST_PP_SEQ_FOR_EACH_I(DEFINE_QC_CONSTRUCTS_helper,_,BLOCK_TAGS_DATA)
